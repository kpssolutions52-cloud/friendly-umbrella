      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <main className="flex-1 overflow-y-auto min-w-0 bg-gradient-to-br from-gray-50 via-white to-blue-50/30">
          <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 py-4 sm:py-6 lg:py-8 xl:py-12">
            <div className="bg-white shadow-xl rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 xl:p-12 prose prose-sm sm:prose lg:prose-lg max-w-none prose-blue prose-headings:font-bold prose-headings:text-gray-900 prose-h1:text-2xl sm:prose-h1:text-3xl lg:prose-h1:text-4xl prose-h1:mb-4 sm:prose-h1:mb-6 prose-h1:bg-gradient-to-r prose-h1:from-blue-600 prose-h1:to-purple-600 prose-h1:bg-clip-text prose-h1:text-transparent prose-h2:text-xl sm:prose-h2:text-2xl prose-h2:mt-6 sm:prose-h2:mt-8 prose-h2:mb-3 sm:prose-h2:mb-4 prose-h2:text-gray-800 prose-h3:text-lg sm:prose-h3:text-xl prose-h3:mt-4 sm:prose-h3:mt-6 prose-h3:mb-2 sm:prose-h3:mb-3 prose-h3:text-gray-700 prose-p:text-sm sm:prose-p:text-base prose-p:text-gray-600 prose-p:leading-relaxed prose-a:text-blue-600 prose-a:font-semibold prose-a:no-underline hover:prose-a:underline prose-strong:text-gray-900 prose-strong:font-bold prose-code:bg-gray-100 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-xs sm:prose-code:text-sm prose-pre:bg-gray-900 prose-pre:text-gray-100 prose-blockquote:border-l-4 prose-blockquote:border-blue-500 prose-blockquote:pl-3 sm:prose-blockquote:pl-4 prose-blockquote:italic prose-blockquote:text-sm sm:prose-blockquote:text-base prose-blockquote:text-gray-700 prose-ul:list-disc prose-ul:pl-5 sm:prose-ul:pl-6 prose-ol:list-decimal prose-ol:pl-5 sm:prose-ol:pl-6 prose-li:my-1 sm:prose-li:my-2">
              {children}
            </div>
          </div>
        </main>
