...
/** Default widths (px) for: company, category, trade, contact, phone, email, status, actions */
export const SUPPLIER_HUB_DEFAULT_COL_WIDTHS = [200, 120, 120, 120, 100, 180, 88, 52];
